...
import com.fundamentosplatzi.sprintboot.fundamentos.dto.UserDto;
...
public interface UserRepository extends JpaRepository<User,Long > {
    ...
    @Query("SELECT new com.fundamentosplatzi.sprintboot.fundamentos.dto.UserDto(u.id, u.name, u.birthDate)" +
           " FROM User u " +
